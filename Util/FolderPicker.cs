    ...
    public class FolderPicker
    {
        ...
        public virtual bool? ShowDialog(IntPtr owner, bool throwOnError = false)
        {
            ...
            if (!string.IsNullOrEmpty(InputPath))
            {
                ...
                var ptr = SHSimpleIDListFromPath(InputPath);
                if (CheckHr(SHCreateItemFromIDList(ptr, typeof(IShellItem).GUID, out var item), throwOnError) != 0)
                    return null;
        ...
        [DllImport("shell32")]
        private static extern int SHCreateItemFromIDList(IntPtr pidl, [MarshalAs(UnmanagedType.LPStruct)] Guid riid, 
            out IShellItem ppv);
